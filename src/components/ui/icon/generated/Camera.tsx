...
export function Camera({ size, color, ...props }: IconProps) {
  return (
    <svg
    ...
    >
      ...
      >
        ...
        />
        <rect width={19.625} height={19.625} x={3.188} y={0.75} rx={3.25} />
      </g>
      <defs>
        <clipPath id="camera__a">
          <path fill="white" d="M0 0h26v26H0z" />
        </clipPath>
      </defs>
    </svg>
  );
